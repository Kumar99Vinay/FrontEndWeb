...
public class Payments implements Serializable {
	...
	private static File f = new File("resources/payments.db");
	Date date = new Date(); 
	...
	String paymentFile = "resources/payments.db";
	String userFile = "resources/users.db";
	...
	void storePayments(Payments p) {
		String outputFile = "resources/payments.db";
		try {
			if (f.length() == 0) {
...
//						 System.out.println("payments of "+username);
//						 System.out.println("User.name  "+user.username);
//						 System.out.println("Payment userto : "+payment.to+"Payment userForm : "+payment.from+" User :"+user.username);
//						 if(username.equals(payment.to)) {
////							  System.out.println("Payment user balance "+payment.balance);
...
////							 }
////							 if(payment.amount <0) {
////								 System.out.println("Rs."+payment.amount+" debited from your account. Balance - Rs. "+payment.balance+" as on "+payment.paymentDate);
////							 }
////							 System.out.println("Payment user balance "+payment.balance);
//							 
//						 }
